...
import com.ssafy.marmar.api.service.UserServiceImpl;
        ...
        if (token != null) {
            ...
            if (userId != null) {
                ...
                if(student != null) {
                    ...
                    TherapistDetails therapistDetails = new TherapistDetails(therapist);
                    UsernamePasswordAuthenticationToken jwtAuthentication = new UsernamePasswordAuthenticationToken(userId,
                            null, therapistDetails.getAuthorities());
                    jwtAuthentication.setDetails(therapistDetails);
                    return jwtAuthentication;
                }
            }
            return null;
